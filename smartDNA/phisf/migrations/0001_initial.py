    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.CharField(default=b'', max_length=256, verbose_name=b'Location')),
        ...
        migrations.AlterIndexTogether(
            name='verification',
            index_together=set([('company_name', 'operator', 'status', 'scan_time', 'id'), ('company_name', 'modified', 'scan_time', 'id', 'status'), ('company_name', 'status', 'scan_time', 'id'), ('company_name', 'asset_code', 'product_details', 'auth_code', 'status', 'scan_time', 'id')]),
        ),
    ]
