...
DATABASES = {
    'default': {
        ...
        'NAME': 'dupontdb',                      # Or path to database file if using sqlite3.
        'USER': 'root',                      # Not used with sqlite3.
        'PASSWORD': 'linksmart-smartdna',                  # Not used with sqlite3.
