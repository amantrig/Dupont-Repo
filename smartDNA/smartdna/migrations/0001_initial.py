    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(default=1, db_index=True, verbose_name=b'Status', choices=[(1, b'Registered'), (2, b'Verified'), (3, b'Tampered'), (4, b'Tampered with line cut'), (5, b'Discrepant Label'), (6, b'Void'), (7, b'Barcode Error'), (8, b'Label Error'), (9, b'Height Error'), (10, b'Released'), (11, b'Audited'), (12, b'Unregistered'), (13, b'Verified-x'), (14, b'Tampered-2'), (15, b'Tampered-3'), (16, b'Scan Error')])),
